...
abstract class BasesfAssetPeer {
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasesfAssetPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasesfAssetPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasesfAssetPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasesfAssetPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasesfAssetPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasesfAssetPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasesfAssetPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasesfAssetPeer', $values, $con, $ret);
    }
