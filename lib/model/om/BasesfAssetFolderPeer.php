...
abstract class BasesfAssetFolderPeer {
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasesfAssetFolderPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasesfAssetFolderPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasesfAssetFolderPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasesfAssetFolderPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasesfAssetFolderPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasesfAssetFolderPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasesfAssetFolderPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasesfAssetFolderPeer', $values, $con, $ret);
    }
